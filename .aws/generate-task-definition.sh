...
# Generate production task definition (staging is generated in CI from this file + vars.CURRICULUM_SERVICE_URL_STAGING)
...
echo "Staging task def is generated in CI from task-definition.json + vars.CURRICULUM_SERVICE_URL_STAGING (do not commit .aws/task-definition-staging.json)."
echo ""
echo "Next steps:"
