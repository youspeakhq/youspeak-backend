...
class EmailLog(BaseModel):
    ...
    send_status = Column(ENUM(EmailSendStatus, name="email_send_status", native_enum=True, values_callable=lambda obj: [e.value for e in obj]), default=EmailSendStatus.PENDING.value, nullable=False, index=True)
